    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(route('slide.list')); ?>">List Slide</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('slide.creat')); ?>">Add Slide</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="<?php echo e(route('geteditcustom')); ?>">Option</a>
                        <a href="<?php echo e(route('creatfeild')); ?>">creat feild</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
