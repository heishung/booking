    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="admin/location/edit/<?php echo e($locations->id); ?>" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        <label>Image</label>
                        <input value="<?php echo e($locations->image); ?>" type="file" name="img_upload" >
                    </div>
                    <div class="form-group">
                        <label>Location content</label>
                        <textarea name="content"  id="demo" class="ckeditor"><?php echo e($locations->content); ?></textarea>
