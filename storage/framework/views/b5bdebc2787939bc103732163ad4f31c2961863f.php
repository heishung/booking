<?php $__env->startSection('content'); ?>
    <div>
        <div class="column has-text-centered text-uppercase bg-grey">
            <a  href="<?php echo e(URL::previous()); ?>"><H1>Booking guide & Term</H1></a>
            <p class="center-block line-grey margin-top-20 margin-bottom-20"></p>
            <div class="container has-text-centered">
                <p>Thank you for your interest in us  If you need to send us an inquiry, please use our Inquiry Form and Manager will respond to you within 24 hours. Or you can wait , please call us : <?php echo e(\App\helpers\Lap::getArrayVal($options,'hotline-off-2')); ?>. </p>
