<?php $__env->startSection('content'); ?>
    ...
    <div class="container home-promotion margin-top-40">
        ...
        <div class="columns">
            <?php $__currentLoopData = $listservices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $posts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="column margin-bottom-20">
                    <div class="promotion-content">
                        ...
                        <div class="promo-content">
                            ...
                            <div class="padding-top-10 padding-bottom-10 has-text-centered">
