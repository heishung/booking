<?php $__env->startSection('content'); ?>
    <div class="bpt-content container">
        <div class="columns home-top-services">
            ...
            <div class="column">
                <div class="product-contents">
                    ...
                    <a href="<?php echo e(route('location.detail',['slug'=>$location->slug])); ?>">
                        <img class="img-product-content" alt="" src="<?php echo e(route('img.view',["p"=>$location->image,'q'=>100])); ?>" width="100%">
                        <div class="product-title has-text-centered">
                            <span class="text"><?php echo e($location->name); ?></span>
                        </div></a>
                </div>
            </div>
        ...
        <div class="box-pagination"><?php echo e($Locations->links()); ?></div>
                ...
                <div class="column is-6">
                    <div class="content act-col-left">
                        <div class="box-ct-left">
                            ...
                            <div class="imgs"><img class="img-res" src="<?php echo e(url('')); ?>/image/activities-on-board.png"></div>
                            <div class="contents">
                            ...
                            <div class="actions">
                                <div class="columns">
                                    <div class="col-md-3">
                                        <a class="button is-warning is-active has-text-centered" href="#" id="view_detail_button">VIEW DETAIL <img alt="#" src="<?php echo e(url('')); ?>/image/chevron-button-right-icon.png" style="padding-bottom: 3px;"></a>
                                    </div>
                    ...
                    <div class="review-frame">
                        <div class="review-content has-text-centered">
                            ...
                            <div style="margin: 10px 0;">
                                <img alt="" src="<?php echo e(url('')); ?>/image/tripad-icon-new.png" style="margin-right: 5px; margin-top: -5px;"><span>Deni C</span>
                            </div>
                            <div class="content">
                            ...
                            </div><a href="#" target="_blank"><img alt="#" class="btn-review-detail" src="<?php echo e(url('')); ?>/image/btn-tripad-view-detail.png"></a>
                        </div>
                    </div>
                </div>
                <div class="column">
